...
#define MAVLINK_MSG_ID_TUNED_FREQUENCY_LEN 4
#define MAVLINK_MSG_ID_187_LEN 4

#define MAVLINK_MSG_ID_TUNED_FREQUENCY_CRC 155
#define MAVLINK_MSG_ID_187_CRC 155
...
{
	return mavlink_msg_tuned_frequency_pack(system_id, component_id, msg, tuned_frequency->tuned_freq);
}
...
{
	return mavlink_msg_tuned_frequency_pack_chan(system_id, component_id, chan, msg, tuned_frequency->tuned_freq);
}
...
static inline void mavlink_msg_tuned_frequency_send(mavlink_channel_t chan, float tuned_freq)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_TUNED_FREQUENCY_LEN];
	_mav_put_float(buf, 0, tuned_freq);
 ...
 */
static inline void mavlink_msg_tuned_frequency_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float tuned_freq)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
